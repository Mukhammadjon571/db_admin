...
const InventoryForm = () => {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <ContentHeader>
        Add Medicine <span className="grow"></span>{" "}
      ...
      <div className="p-10">
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">Medicine Name:</div>
          <input
            type="text"
            value={fullName}
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">Medicine ID:</div>
          <input
            type="text"
            value={fullName}
            placeholder="Medicine Name:"
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">Quantity in Number:</div>
          <input
            type="text"
            value={passport}
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">Medicine Group:</div>
          <select
            name=""
            value={select}
            onChange={setselect}
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">How to Use:</div>
          <textarea
            type="text"
            value={passport}
        ...
        <div className="flex items-center justify-center mt-3">
          <div className="w-[300px]">Side Effects:</div>
          <textarea
            type="text"
            value={passport}
